...
const { GetBanWord, RemoveBannedWord, setBannedWord, GetBannedWords } = require("./ban_words.js");
	...
	if (new_word) {
		try {
			...
			if (wordExist) {
				...
				return await interaction.reply("This word dosen't exist on database of this server!");
			}
		} catch (error) {
