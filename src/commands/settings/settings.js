...
} = require("../../models/settings/warn/setWarnPunishmentType");
      ...
      subCommandGroup
        ...
        .addSubcommand((subCommand) =>
          subCommand
            .setName("punishment")
            .setDescription(
              "Select the type of punishment the user will recieve after reach warns limit!",
            )
            ...
            .addIntegerOption((option) =>
              option
                .setName("type")
                .setDescription(
                  "The punish type! (1: Kick, 2: Ban, 3: Timeout)",
                )
                .setRequired(true)
                .addChoices(
                  { name: "Kick", value: 1 },
