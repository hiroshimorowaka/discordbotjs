	...
	data: new SlashCommandBuilder()
		...
		.addSubcommand((subCommand) =>
			subCommand
				...
				.addUserOption((option) =>
					option.setName("user").setDescription("The user to be timed out").setRequired(true),
				)
		...
		.addSubcommand((subCommand) =>
			subCommand
				...
				.setDescription("Set timeout for a user!")
				.addUserOption((option) =>
					option.setName("user").setDescription("The user to remove timeout").setRequired(true),
				),
		),
